 ...
 * | 本人任意状态 | ✅ | ✅ | 见编辑策略 | ✅（创建人本人，无关状态） | 上架/下线 |
 * | 他人未上架（非待审） | ✅ | ❌ | ❌ | ❌ | 上架/下线 |
 * | 他人未上架（待审核） | ✅ | ✅ 只读（列表「审核」） | ❌ | ❌ | 审核通过/驳回；上架/下线 |
 * | 他人已下线 | ✅ | ❌ | ❌ | ❌ | 上架 |
 * | 他人已上架 | ✅ | ✅ 只读 | ❌ | ❌ | 下线 |
 *
 * 原则：管理员可对任意路线上架/下线；删除仅限创建人本人（与发布/审核状态无关）；不可改他人内容，仅审核。
 * 导游：本人全流程（含任意状态可删）；他人仅已上架只读。
 */
