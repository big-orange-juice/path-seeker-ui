    ...
    <DialogContent class="max-h-[90vh] overflow-hidden p-0">
      ...
      <form class="max-h-[calc(90vh-61px)] space-y-4 overflow-y-auto px-5 py-4" @submit.prevent="submitForm">
        <section class="grid gap-3 md:grid-cols-2">
          <div class="space-y-2">
            <label class="text-sm font-medium">馆藏名称</label>
        ...
        <section class="grid gap-3 md:grid-cols-2">
          <div class="space-y-2">
            <label class="text-sm font-medium">类别</label>
            <Input v-model="formState.category" placeholder="如 青铜器 / 书画 / 陶瓷" />
          </div>
          <div class="space-y-2">
            <label class="text-sm font-medium">重点展品</label>
        ...
        <section class="grid gap-3 md:grid-cols-2">
          <div class="space-y-2">
            <label class="text-sm font-medium">年代/朝代</label>
        ...
        <section class="grid gap-3 md:grid-cols-2">
          <div class="space-y-2">
            <label class="text-sm font-medium">推荐停留时长</label>
            <Input
        ...
        <section class="space-y-2">
          <label class="text-sm font-medium">馆藏描述</label>
          <Textarea
        ...
        <section class="rounded-lg border border-border/60">
          ...
          <div
            v-if="showMoreFields"
            class="space-y-3 border-t border-border/60 px-3 py-3">
            <div class="grid gap-3 md:grid-cols-2">
              <div class="space-y-2">
                <label class="text-sm font-medium">馆藏编码</label>
                <Input v-model="formState.exhibitCode" placeholder="如 EXH-BR-001" />
              </div>
              <div class="space-y-2">
                <label class="text-sm font-medium">展柜号</label>
