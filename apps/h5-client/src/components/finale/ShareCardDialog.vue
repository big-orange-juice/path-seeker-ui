...
.share-card {
  ...
  box-sizing: border-box;
  aspect-ratio: 0.72;
  border: 1px solid rgba(232, 201, 138, 0.58);
...
.share-card-cover {
  z-index: -1;
  background:
    linear-gradient(180deg, rgba(9, 8, 6, 0.3) 0%, rgba(10, 8, 6, 0.1) 36%, rgba(11, 9, 7, 0.88) 100%),
    linear-gradient(90deg, rgba(8, 7, 5, 0.35), transparent 34%, rgba(8, 7, 5, 0.26));
}
.share-card-grain {
  z-index: -1;
  opacity: 0.34;
