...
const items: TabItem[] = [
  { label: "大厅", icon: "compass", routeName: "shell-hall", value: "hall" },
  { label: "游玩", icon: "route", routeName: "shell-playing", value: "playing" },
  { label: "归档", icon: "archive", routeName: "shell-archive", value: "archive" },
]
